...
export default function Generator(props) {
  ...
  {/* Dynamically populate this from AI or another source */}
  {['type1', 'type2'].map((type, typeIndex) => {
    return (
      <button onClick={() => {
        setMuscles([]);
        setPoison(type);
  ...
  {/* Use a dynamic list for goal schemes */}
  {['goal1', 'goal2'].map((scheme, schemeIndex) => {
    return (
      <button onClick={() => {
        setGoal(scheme)
